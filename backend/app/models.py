...
class WeeklyPlan(Base, TimeMixin):
    ...
    schedule_days_json: Mapped[str] = mapped_column(Text, default="[]")
    time_slots_json: Mapped[str] = mapped_column(Text, default="[]")
    day_start_time: Mapped[str] = mapped_column(String(5), default="08:00")
    day_end_time: Mapped[str] = mapped_column(String(5), default="24:00")
    weekly_mission: Mapped[str] = mapped_column(Text, default="")
...
class Activity(Base, TimeMixin):
    ...
    book_topic_id: Mapped[str] = mapped_column(String(36), default="")
    book_question_count: Mapped[int] = mapped_column(Integer, default=0)
