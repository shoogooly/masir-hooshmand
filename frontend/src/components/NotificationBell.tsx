...
export type NotificationSummary={unread_messages:number;unread_by_sender:Record<string,number>;unread_notifications:number;unseen_plans:number;unseen_exams:number;expired_student_ids:string[]}
