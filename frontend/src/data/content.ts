...
export const steps = [
  ...
  { icon: BrainCircuit, title: 'تحلیل هوشمند', text: 'مهیاد وضعیت و داده‌های آموزشی شما را بررسی می‌کند.' },
...
export const testimonials = [
  { name: 'پارسا رضایی', meta: 'رتبه ۸۱۲ کنکور تجربی ۱۴۰۴', text: 'گزارش‌های دقیق مهیاد باعث شد بفهمم کجا زمانم را از دست می‌دهم و برنامه‌ام واقعاً قابل اجرا شد.' },
