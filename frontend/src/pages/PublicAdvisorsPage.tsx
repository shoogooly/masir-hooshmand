...
export default function PublicAdvisorsPage(){
 ...
 return <div className="public-content-shell" dir="rtl"><header><Link to="/"><Brand light/></Link><nav><Link to="/">صفحه اصلی</Link><Link to="/articles">مقالات</Link><Link className="public-action" to="/register">شروع ثبت‌نام</Link></nav></header><main><div className="public-hero"><span>همراه مسیر تحصیلی شما</span><h1>معرفی مشاوران مهیاد</h1><p>پیش از ثبت‌نام، حوزه فعالیت و سابقه حرفه‌ای مشاوران تأییدشده را ببینید.</p></div>{isLoading?<p className="empty-public">در حال دریافت مشاوران…</p>:<>{section('upper_secondary','مشاوران متوسطه دوم')}{section('lower_secondary','مشاوران متوسطه اول')}</>}</main></div>
}
