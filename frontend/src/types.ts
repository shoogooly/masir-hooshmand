...
export interface WeeklyPlan { id:string; student_id:string; title:string; week_label:string; version:number; status:string; published_at?:string; activities:PlanActivity[] }
